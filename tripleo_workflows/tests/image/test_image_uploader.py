...
from tripleo_workflows.image.exception import ImageUploaderException
from tripleo_workflows.image import image_uploader
from tripleo_workflows.tests import base
from tripleo_workflows.tests.image import fakes
...
class TestImageUploadManager(base.TestCase):
    ...
    @mock.patch('tripleo_workflows.image.base.open',
                mock.mock_open(read_data=filedata), create=True)
    @mock.patch('tripleo_workflows.image.image_uploader.'
    ...
    @mock.patch('tripleo_workflows.image.image_uploader.Client')
...
class TestDockerImageUploader(base.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher = mock.patch(
            'tripleo_workflows.image.image_uploader.Client')
