...
from tripleo_workflows.image.base import BaseImageManager
from tripleo_workflows.image.exception import ImageSpecificationException
from tripleo_workflows.tests import base as testbase
...
class TestBaseImageManager(testbase.TestCase):
    ...
    @mock.patch('tripleo_workflows.image.base.BaseImageManager.'
                'APPEND_ATTRIBUTES',
