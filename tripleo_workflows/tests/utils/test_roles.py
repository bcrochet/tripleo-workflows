...
from tripleo_workflows.exception import NotFound
from tripleo_workflows.exception import RoleMetadataError
from tripleo_workflows.tests import base
from tripleo_workflows.utils import roles as rolesutils
...
class TestRolesUtils(base.TestCase):
    ...
    @mock.patch('tripleo_workflows.utils.roles.check_role_exists')
    @mock.patch('tripleo_workflows.utils.roles.get_roles_list_from_directory')
    def test_generate_roles_data_from_directory(self, get_roles_mock,
        ...
        with mock.patch('tripleo_workflows.utils.roles.open', m) as open_mock:
    ...
    def test_validate_role_yaml_with_file(self):
        m = mock.mock_open(read_data=SAMPLE_ROLE)
        with mock.patch('tripleo_workflows.utils.roles.open', m):
