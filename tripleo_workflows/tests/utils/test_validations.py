...
from tripleo_workflows.constants import PLAN_NAME_PATTERN
from tripleo_workflows.tests import base
from tripleo_workflows.utils import validations
...
class LoadValidationsTest(base.TestCase):
    ...
    @mock.patch('tripleo_workflows.utils.validations.DEFAULT_METADATA')
    ...
    def test_load_validations_no_group(self, mock_glob):
        ...
        with mock.patch('tripleo_workflows.utils.validations.open',
                        mock_open_context):
...
class RunValidationTest(base.TestCase):
    ...
    @mock.patch('tripleo_workflows.utils.validations.find_validation')
    @mock.patch('oslo_concurrency.processutils.execute')
