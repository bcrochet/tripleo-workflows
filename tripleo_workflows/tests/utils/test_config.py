...
from tripleo_workflows.tests.fake_config import fakes
from tripleo_workflows.utils import config as ooo_config
...
class TestConfig(base.TestCase):
    ...
    @patch('tripleo_workflows.utils.config.Config.get_config_dict')
    @patch('tripleo_workflows.utils.config.Config.get_deployment_data')
