...
from tripleo_workflows.actions import validations
from tripleo_workflows import constants
from tripleo_workflows.tests import base
from tripleo_workflows.tests.utils import test_validations
from tripleo_workflows.utils import nodes as nodeutils


class GetPubkeyActionTest(base.TestCase):

    @mock.patch(
        'tripleo_workflows.actions.base.TripleOAction.get_workflow_client')
    ...
    @mock.patch(
        'tripleo_workflows.actions.base.TripleOAction.get_workflow_client')
    @mock.patch('tripleo_workflows.utils.passwords.create_ssh_keypair')
...
class Enabled(base.TestCase):
    ...
    @mock.patch(
        'tripleo_workflows.actions.validations.Enabled._validations_enabled')
    @mock.patch(
        'tripleo_workflows.actions.base.TripleOAction.get_workflow_client')
...
class ListValidationsActionTest(base.TestCase):
    ...
    @mock.patch('tripleo_workflows.utils.validations.load_validations')
...
class RunValidationActionTest(base.TestCase):
    ...
    @mock.patch(
        'tripleo_workflows.actions.base.TripleOAction.get_workflow_client')
    @mock.patch('tripleo_workflows.utils.validations.write_identity_file')
    @mock.patch('tripleo_workflows.utils.validations.cleanup_identity_file')
    @mock.patch('tripleo_workflows.utils.validations.run_validation')
...
class TestCheckBootImagesAction(base.TestCase):
    ...
    @mock.patch(
        'tripleo_workflows.actions.validations.CheckBootImagesAction'
        '._check_for_image')
...
class TestCheckFlavorsAction(base.TestCase):
    def setUp(self):
        ...
        compute_patcher = mock.patch(
            'tripleo_workflows.actions.base.TripleOAction.get_compute_client',
