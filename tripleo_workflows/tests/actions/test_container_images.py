...
from tripleo_workflows.actions import container_images
...
class PrepareContainerImageEnvTest(base.TestCase):
    ...
    @mock.patch("tripleo_workflows.actions.container_images."
                "PrepareContainerImageEnv.get_object_client")
    @mock.patch("tripleo_workflows.actions.heat_capabilities."
                "UpdateCapabilitiesAction")
    @mock.patch("tripleo_workflows.image.kolla_builder.KollaImageBuilder")
