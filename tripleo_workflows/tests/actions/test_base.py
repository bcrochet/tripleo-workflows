...
from tripleo_workflows.tests import base as tests_base
from tripleo_workflows.utils import keystone as keystone_utils
...
class TestActionsBase(tests_base.TestCase):
    ...
    @mock.patch("tripleo_workflows.actions.base.swift_client.Connection")
