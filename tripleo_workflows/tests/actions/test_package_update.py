...
from tripleo_workflows.actions import package_update
...
class UpdateStackActionTest(base.TestCase):
    ...
    @mock.patch('tripleo_workflows.actions.templates.'
                'ProcessTemplatesAction.run')
    ...
    @mock.patch('tripleo_workflows.utils.plan.get_env')
    @mock.patch('tripleo_workflows.utils.plan.update_in_env')
