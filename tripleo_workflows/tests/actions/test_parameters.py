...
from tripleo_workflows.actions import parameters
from tripleo_workflows import constants
from tripleo_workflows import exception
from tripleo_workflows.tests import base
from tripleo_workflows.utils import passwords as password_utils
...
class UpdateParametersActionTest(base.TestCase):
    ...
    @mock.patch('tripleo_workflows.actions.parameters.uuid')
    @mock.patch('heatclient.common.template_utils.'
                'process_multiple_environments_and_files')
    @mock.patch('heatclient.common.template_utils.'
...
class UpdateRoleParametersActionTest(base.TestCase):
    ...
    @mock.patch('tripleo_workflows.actions.base.TripleOAction.'
                'cache_set')
    @mock.patch('tripleo_workflows.utils.parameters.'
                'set_count_and_flavor_params')
    @mock.patch('tripleo_workflows.actions.base.TripleOAction.'
...
class GeneratePasswordsActionTest(base.TestCase):
    ...
    @mock.patch('tripleo_workflows.actions.base.TripleOAction.'
                'get_orchestration_client')
    @mock.patch('tripleo_workflows.utils.passwords.'
...
class GenerateFencingParametersActionTestCase(base.TestCase):
    ...
    @mock.patch('tripleo_workflows.utils.nodes.generate_hostmap')
    @mock.patch('tripleo_workflows.actions.base.TripleOAction.'
                'get_compute_client')
    @mock.patch('tripleo_workflows.actions.base.TripleOAction.'
                'get_baremetal_client')
...
class GetProfileOfFlavorActionTest(base.TestCase):
    ...
    @mock.patch('tripleo_workflows.utils.parameters.get_profile_of_flavor')
    @mock.patch('tripleo_workflows.actions.base.TripleOAction.'
                'get_compute_client')
