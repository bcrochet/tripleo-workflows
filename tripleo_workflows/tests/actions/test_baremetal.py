...
from tripleo_workflows.actions import baremetal
...
class TestConfigureBootAction(base.TestCase):
    ...
    def setUp(self):
        ...
        glance_patcher = mock.patch(
            'tripleo_workflows.actions.base.TripleOAction.get_image_client',
...
class TestCellV2DiscoverHostsAction(base.TestCase):
    ...
    @mock.patch('tripleo_workflows.utils.nodes.run_nova_cell_v2_discovery')
