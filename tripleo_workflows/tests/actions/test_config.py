...
from tripleo_workflows.actions import config
...
class GetOvercloudConfigActionTest(base.TestCase):
    ...
    @mock.patch('tripleo_workflows.utils.config.Config.download_config')
...
class DownloadConfigActionTest(base.TestCase):
    ...
    @mock.patch('tripleo_workflows.utils.swift.download_container')
